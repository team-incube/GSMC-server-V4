...
- Only report what you actually found via search — label any training-knowledge fill-ins explicitly

## Operational Guidelines

- Conduct multiple searches from different angles
- Cross-check date-sensitive claims (e.g. version numbers) against at least 2 sources before including them in Detailed Findings
