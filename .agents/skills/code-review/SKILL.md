---
name: code-review
description: Run a structured checklist over changed files — naming conventions, DTO, Kotlin style, JPA/transaction correctness, GraphQL schema, and security basics. Produces a pass/warning/error report.
---
...
- [ ] Entity/repository named correctly? (e.g. `MemberJpaEntity`, `BlackListRedisRepository`)
