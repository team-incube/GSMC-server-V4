...
/**
 * 개발자 도메인에서 사용하는 근거 자료 JPA 저장소 인터페이스입니다.
 * 회원 삭제 시 참조 데이터 존재 여부 확인에만 사용됩니다.
 *
 * `evidence` 도메인에도 자체 저장소가 있으나 Spring Data JPA 빈 이름 충돌을 피하기 위해(#71)
 * 도메인 접두사를 붙여 명명한다.
 */
interface DeveloperEvidenceJpaRepository : JpaRepository<EvidenceJpaEntity, Long> {
    /**
     * 해당 사용자의 근거 자료가 존재하는지 확인한다.
     *
